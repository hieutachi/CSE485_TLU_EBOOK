...
> **Phiếu học tập liên quan:** [Phiếu 11](./worksheets/phieu-11-dashboard-create.md) — chuỗi MiniShop
...
|------|--------|----------|
| **Trên lớp** | Categories: index + create/store | [Phiếu 11 — mục 2](./worksheets/phieu-11-dashboard-create.md) |
| **Về nhà** | Products: create có select + stats Dashboard thật | [Phiếu 11 — mục 3](./worksheets/phieu-11-dashboard-create.md) |

**Cầu nối Buổi 12 (đích cuối bài tập):** **Update + Delete** đủ **cả 2 bảng** + `docs/FINAL.md`.

→ [Buổi 12](./12-buoi-12-dashboard-update-delete.md) · [Phiếu 12](./worksheets/phieu-12-dashboard-crud.md)
